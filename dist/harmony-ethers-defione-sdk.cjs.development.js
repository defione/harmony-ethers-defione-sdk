...
var _require = /*#__PURE__*/require("fastestsmallesttextencoderdecoder"),
...
function formatDescription(value) {
  ...
  return [textEncoder.encode((_value$name = value.name) != null ? _value$name : ""), textEncoder.encode((_value$identity = value.identity) != null ? _value$identity : ""), textEncoder.encode((_value$website = value.website) != null ? _value$website : ""), textEncoder.encode((_value$securityContac = value.securityContact) != null ? _value$securityContac : ""), textEncoder.encode((_value$details = value.details) != null ? _value$details : "")];
}
...
function handleText(value) {
  return textDecoder.decode(bytes.arrayify(value));
}
...
exports.tHRP = tHRP;
//# sourceMappingURL=harmony-ethers-defione-sdk.cjs.development.js.map
